...
const kNextHopProtocol = Symbol('kNextHopProtocol');
const kWorkerStart = Symbol('kWorkerStart');
const kRedirectStart = Symbol('kRedirectStart');
const kRedirectEnd = Symbol('kRedirectEnd');
const kFetchStart = Symbol('kFetchStart');
const kDomainLookupStart = Symbol('kDomainLookupStart');
const kDomainLookupEnd = Symbol('kDomainLookupEnd');
const kConnectStart = Symbol('kConnectStart');
const kConnectEnd = Symbol('kConnectEnd');
const kSecureConnectionStart = Symbol('kSecureConnectionStart');
const kRequestStart = Symbol('kRequestStart');
const kResponseStart = Symbol('kResponseStart');
const kResponseEnd = Symbol('kResponseEnd');
const kTransferSize = Symbol('kTransferSize');
const kEncodedBodySize = Symbol('kEncodedBodySize');
const kDecodedBodySize = Symbol('kDecodedBodySize');
const kResponseStatus = Symbol('kResponseStatus');
const kRenderBlockingStatus = Symbol('kRenderBlockingStatus');
