...
class Curl {
  ...
  #onDone = (code, ...timingInfo) => {
    ...
    this.#timingInfo.totalTime = totalTime;
    this.#timingInfo.namelookupTime = namelookupTime;
    this.#timingInfo.connectTime = connectTime;
    this.#timingInfo.appconnectTime = appconnectTime;
    this.#timingInfo.pretransferTime = pretransferTime;
    this.#timingInfo.starttransferTime = starttransferTime;
    this.#timingInfo.redirectTime = redirectTime;
